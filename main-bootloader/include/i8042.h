...
extern bool i8042_is_present(void);

extern void i8042_enable_a20(void);
extern void i8042_disable_a20(void);
...
static inline void i8042_wait_until_ready_to_read(void) {
	while (!i8042_is_ready_to_read()) {}
}

static inline void i8042_wait_until_ready_to_write(void) {
	while (!i8042_is_ready_to_write()) {}
}
